...
contract SecureSign is Ownable {
    // A SecureSign contract represents a esignature processto be completed.
    
    string private title; // Title of the SecureSign contract.
    string private resourceUrl; // Link to the SecureSign documents to be signed.
    ...
    constructor(string memory _title,  address _signerAddress) {
        console.log("Deploying a SecureSign contract with title:", _title);
        title = _title;
